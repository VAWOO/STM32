...
#define BTN_down_EXTI_IRQn EXTI3_IRQn
...
#define SEG_PIN1_Pin GPIO_PIN_12
#define SEG_PIN1_GPIO_Port GPIOF
#define SEG_PIN2_Pin GPIO_PIN_13
#define SEG_PIN2_GPIO_Port GPIOF
#define SEG_PIN3_Pin GPIO_PIN_14
#define SEG_PIN3_GPIO_Port GPIOF
